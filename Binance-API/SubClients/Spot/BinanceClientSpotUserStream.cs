...
namespace BinanceAPI.SubClients.Spot
{
    ...
    public class BinanceClientSpotUserStream : IBinanceClientUserStream
    {
        ...
        {
            var result = await _baseClient.SendRequestInternal<BinanceListenKey>(GetUri.New(_baseClient.BaseAddress, getListenKeyEndpoint, api, userDataStreamVersion), HttpMethod.Post, ct).ConfigureAwait(false);
