...
namespace BinanceAPI.SubClients.Margin
{
    ...
    public class BinanceClientMarginMarket : IBinanceClientMarginMarket
    {
        ...
        {
            return await _baseClient.SendRequestInternal<IEnumerable<BinanceMarginAsset>>(GetUri.New(_baseClient.BaseAddress, marginAssetsEndpoint, marginApi, marginVersion), HttpMethod.Get, ct).ConfigureAwait(false);
        }
        ...
        {
            return await _baseClient.SendRequestInternal<IEnumerable<BinanceMarginPair>>(GetUri.New(_baseClient.BaseAddress, marginPairsEndpoint, marginApi, marginVersion), HttpMethod.Get, ct).ConfigureAwait(false);
        }
