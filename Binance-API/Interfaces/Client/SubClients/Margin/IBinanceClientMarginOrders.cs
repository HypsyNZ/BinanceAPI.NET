...
namespace BinanceAPI.Interfaces.SubClients.Margin
{
    /// <summary>
    ...
    public interface IBinanceClientMarginOrders
    {
        ...
        Task<WebCallResult<BinanceOrderBase>> GetMarginAccountOrderAsync(string symbol, long? orderId = null, string? origClientOrderId = null, bool? isIsolated = null, long? receiveWindow = null, CancellationToken ct = default);
        ...
        Task<WebCallResult<IEnumerable<BinanceOrderBase>>> GetMarginAccountOpenOrdersAsync(string? symbol = null, bool? isIsolated = null, int? receiveWindow = null, CancellationToken ct = default);
        ...
        Task<WebCallResult<IEnumerable<BinanceOrderBase>>> GetMarginAccountOrdersAsync(string symbol, long? orderId = null, DateTime? startTime = null, DateTime? endTime = null, int? limit = null, bool? isIsolated = null, int? receiveWindow = null, CancellationToken ct = default);
